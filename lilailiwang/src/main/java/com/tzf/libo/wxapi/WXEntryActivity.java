...
public class WXEntryActivity extends BaseActivity implements IWXAPIEventHandler {
    ...
    private static final String WEIXIN_APP_ID = "wx7f254ed29afea480";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        contentEditText = (MaterialEditText) findViewById(R.id.contentEditText);
        Intent intent = getIntent();
        Bundle bundle = intent.getExtras();
        message = bundle.getString("message");
        if (!StringUtil.isEmpty(message)) {
            contentEditText.setText(message);
            contentEditText.setSelection(message.length());
        }
